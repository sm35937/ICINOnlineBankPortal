...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-05-29 07:19:10',NULL),('diagnostics.include_raw','OFF','2021-05-29 07:19:10',NULL),('ps_thread_trx_info.max_length','65535','2021-05-29 07:19:10',NULL),('statement_performance_analyzer.limit','100','2021-05-29 07:19:10',NULL),('statement_performance_analyzer.view',NULL,'2021-05-29 07:19:10',NULL),('statement_truncate_len','64','2021-05-29 07:19:10',NULL);
...
-- Dump completed on 2021-07-25 14:18:04
-- MySQL dump 10.13  Distrib 8.0.25, for Win64 (x86_64)
--
-- Host: localhost    Database: icinbanking
-- ------------------------------------------------------
-- Server version	8.0.25
...
INSERT INTO `appointment` VALUES (15,_binary '','2021-06-06 08:06:00','I want to schedule an appointment for a cheque book of 50 pages on the above date.','India',5);
/*!40000 ALTER TABLE `appointment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `appointment_for_chequebook_request`
--

DROP TABLE IF EXISTS `appointment_for_chequebook_request`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `appointment_for_chequebook_request` (
  `id` bigint NOT NULL,
  `confirmed` bit(1) NOT NULL,
  `date` datetime DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  ...
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKh1j0ng85rd54umiamvv2i2dga` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `appointment_for_chequebook_request`
--

LOCK TABLES `appointment_for_chequebook_request` WRITE;
/*!40000 ALTER TABLE `appointment_for_chequebook_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `appointment_for_chequebook_request` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `primary_account` VALUES (3,558.00,11223146),(16,222.00,11223146),(17,1111.00,11223147),(21,22333.00,11223149);
...
INSERT INTO `primary_transaction` VALUES (7,1000,1458.00,'2021-06-05 17:08:02','Deposit to Primary Account','Finished','Account',3),(9,800,658.00,'2021-06-05 17:16:13','Withdraw from Primary Account','Finished','Account',3),(10,100,558.00,'2021-06-05 17:34:02','Between account transfer from Primary to Savings','Finished','Transfer',3);
...
INSERT INTO `recipient` VALUES (12,'34567890912323456','This is a new recipient','r@gmail.com','Ratna','3456127890',5),(13,'34567890910323455','This is another recipient','k@gmail.com','kush','1234567890',5);
...
INSERT INTO `savings_account` VALUES (4,10467.00,11223147),(18,0.00,11223148),(22,0.00,11223150);
...
INSERT INTO `savings_transaction` VALUES (8,10000,10407.00,'2021-06-05 17:09:41','Deposit to savings Account','Finished','Account',4),(11,100,10507.00,'2021-06-05 17:34:02','Received transfer from Primary','Finished','Transfer',4),(14,40,10467.00,'2021-06-05 17:50:02','Transfer to recipient Ratna','Finished','Transfer',4);
...
INSERT INTO `user` VALUES (5,'sm1@gmail.com',_binary '','Shivani','Baraskar','$2a$12$LtbYtEzOBdnsiD/E9Wtj2O4QpE6tba3G4H7EXRjsuDANlkP7I.gbK','1234567890','om',3,4),(19,'kb@gmail.com',_binary '','kb','kb','$2a$12$DWCryEwHwbTYCegib92tk.4s56HY6ksL83LZZX74S8DNatWfZopmi','8907654321','kb',17,18),(23,'admin@google.com',_binary '','admin','admin','$2a$12$hZR7pcSf0JU/OTXR3TOyuumZA26gDp4YUuVp77Xx8rHzzmddqzX.y','8906754321','admin',21,22);
...
INSERT INTO `user_role` VALUES (6,0,5),(20,0,19),(24,1,23);
/*!40000 ALTER TABLE `user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'icinbanking'
--

--
-- Dumping routines for database 'icinbanking'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2021-07-25 14:18:05
